...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-vum0&fc!vwf0=b!j!s5zr4h8k+tq8w72bj)&a@ln-l%bt%$m0_')
...
if DEBUG:
    ...
    DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='PRUDEV II <noreply@prudev.org>')
